...
class Bénévoles(models.Model):
    ...
    membre_adhérents = models.ForeignKey('Membre_Adhérents', models.DO_NOTHING, db_column='Membre_Adhérents', blank=True, null=True)  # Field name made lowercase.
...
class General(models.Model):
    ...
    annéecourante = models.CharField(db_column='Année', max_length=500, blank=True, null=True)  # Field name made lowercase.$
    membership = models.CharField(db_column='membership', max_length=500, blank=True, null=True)  # Field name made lowercase.
    pole_benevolat = models.CharField(db_column='pole_benevolat', max_length=500, blank=True, null=True)  # Field name made lowercase.
...
class Membre_Adhérents(models.Model):
...
class Membre_De_La_Family(models.Model):
...
class Utilisateur(models.Model):
    ...
    mot_de_passe = models.CharField(unique=True, max_length=255)
...
class personne_ressource(models.Model):
    ID_PRessource = models.AutoField(db_column='ID_PRessource', primary_key=True)
    prénom = models.CharField(db_column='prénom', max_length=50, blank=True, null=True)
    ...
    sexe = models.CharField(db_column='sexe', max_length=20, blank=True, null=True)
    profession = models.CharField(db_column='profession', max_length=50, blank=True, null=True)  # Field name made lowercase.
    structure = models.CharField(db_column='structure', max_length=50, blank=True, null=True)  # Field name made lowercase.
    secteur_activité = models.CharField(db_column='secteur_activité', max_length=50, blank=True, null=True)  # Field name made lowercase.
    pays_de_residence = models.CharField(db_column='pays_de_residence', max_length=50, blank=True, null=True)  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'personne_ressource'
